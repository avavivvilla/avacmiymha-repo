...
# ---------------------------------------------------------------------------
IMAGE_PATH = "/home/avavivvilla/v.1/sections/cat_myelin/catsec_m105.jpg"                 # <-- put your image filename here
COMPARISON_PATH = "comparison.png"         # where the side-by-side image is saved
...
plt.imshow(img, cmap="gray")        # show the original; cmap="gray" = greyscale
plt.title("Original")               # a label above the picture
plt.axis("off")                     # hide the x/y number axes (not useful here)
...
import glob            # finds files matching a pattern (put with imports up top)
